...
const Header: React.FC<IHeaderProps> = ({ openCart, tax, totalPrice }) => {
    return (
            ...
            <div className={styles.header__right}>
                <ul className={styles.header__list}>
                    <li className={styles.header__listItem}>
                        <svg onClick={openCart} width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <span>{(tax + totalPrice).toLocaleString()} руб.</span>
                    </li>
